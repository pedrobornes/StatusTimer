...
const PROBE_SOURCE_BY_SLUG: Record<string, string> = {
  ...
  "teamfight-tactics": "Official Riot status page",
  hearthstone: "Official Blizzard status page",
  "world-of-warcraft": "Official Blizzard status page",
  "diablo-4": "Official Blizzard status page",
  "overwatch-2": "Official Blizzard status page",
